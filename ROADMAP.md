...
- 🚩 **`docs/MODEL-ECONOMICS.md` repeats and CONTRADICTS house doctrine — queued 2026-08-09 from atelier's
  estate-wide duplication audit.** This item previously read *"this repo's file is its own document, not a
